...
python3 detect_from_video.py   --robot-name linker_l20   --video-path data/hand.mp4   --retargeting-type vector   --hand-type right   --output-path data/hand_l20.pkl

* --retargeting-type vector / dexpilot
